                            ...
                            <tbody>
                                ...
                                if ($resultAppointment->num_rows > 0) {
                                    while ($row = $resultAppointment->fetch_assoc()) {
                                        ...
                                        // Delete button
                                       echo '<a class="custom-button" href="delete-appointment.php?appointmentId='.$row["appointment_id"] .' onclick="return confirm(\'Are you sure you want to permanently delete this appointment?\')" style="background-color: #8B0000"><i class="fas fa-trash"></i></a>';
                                        echo "</td>";
                                        echo "</tr>";
