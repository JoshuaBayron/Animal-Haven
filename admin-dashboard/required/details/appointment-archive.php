    ...
    <section id="pet-status" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Appointments Archive <span style="font-size:10px">On this page, you can restore, and permanently delete appointment. </span></h2>
        </div>
        ...
        <div class="row" data-aos="fade-in">
          ...
          <div style="width: 100%; max-height: 430px; overflow-x: auto; overflow-y: auto;">
              <?php include '../tables/appointment-archive.php'?>
          </div>
        ...
        <div class="d-flex justify-content-end">
        <button onclick="window.location.href='pet-status.php'" style="color:#E1D9D1;"><i class="fas fa-arrow-left" style="color: #E1D9D1;"></i></button>
        </div>
