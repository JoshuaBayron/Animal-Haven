    ...
    <section id="staff" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Activity Log <span style="font-size:10px">On this page, you can edit, delete, and register staff. </span></h2>
        </div>
        ...
        <div class="d-flex justify-content-end">
          <form method="GET" class="form-inline">
            <div class="form-group">
              ...
              <button type="button" style="margin:0" onclick="clearAllData()">Clear All</i></button>
        ...
        <div class="row" data-aos="fade-in">
          <div class="mt-5 mt-lg-0 d-flex align-items-stretch">
            <div style="width: 100%; height:430px; overflow: auto;">
              <?php include '../tables/activity-log.php'?>
            </div>
          </div>
        </div>
...
function clearAllData() {
    if (confirm("Are you sure you want to clear all data?")) {
        $.ajax({
            type: 'POST',
            url: 'backend/clear_data.php',
            data: { action: 'clear_all_data' },
            success: function(response) {
                alert(response); // Display the success message
                window.location.reload(); // Reload the page after successful clearance
            },
