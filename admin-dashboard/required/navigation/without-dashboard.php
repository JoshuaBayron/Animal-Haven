    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="customers.php" class="nav-link scrollto"><i class="fas fa-check-double"></i><span>Verify Online Users</span></a></li>
          ...
          <li><a href="activity-log.php" class="nav-link scrollto"><i class="fas fa-history"></i><span>Activity Log</span></a></li>
        </ul>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
