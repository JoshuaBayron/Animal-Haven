            ...
            if ($_SERVER["REQUEST_METHOD"] == "GET") {
                ...
                if (mysqli_num_rows($result) == 1) {
                    ...
                    <form action="../backend/crude.php" method="POST" id="add-staff" class="login100-form validate-form"
                        ...
                        <input type="text" name="doctor" value="<?php echo $fullname; ?>">
                        ...
                        <div class="form-container">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Service">
                                ...
                                <span class="focus-input100" data-placeholder="&#xf207; Service Availed"></span>
                            </div>
                            ...
                            <div class="wrap-input100 validate-input">
                                ...
                                <span class="focus-input100" data-placeholder="&#xf207; Animal Status"></span>
                            </div>
                        ...
                        <div class="form-container">
                            <div class="wrap-input100 validate-input" data-validate="Start Date">
                                ...
                                <span class="focus-input100" data-placeholder="&#xf207; Appointed Date"></span>
                            </div>
                            ...
                            <div class="wrap-input100 validate-input" data-validate="End Date">
                                ...
                                <span class="focus-input100" data-placeholder="&#xf207; Turn-over Date"></span>
                            </div>
                        </div>
...
<script>
        ...
        var elementIds = ["status", "service", "start_date", "end_date"];
