  ...
  <div class="container">
    ...
    <form method="GET" class="form-inline">
        <div class="form-group">
         ...
         <button href="animal-info.php"><i class="fas fa-sync-alt" style="color: #E1D9D1;"></i></button>
        </div>
    ...
    <div class="row" data-aos="fade-in"> 
      ...
      <div class="mt-5 mt-lg-0 d-flex align-items-stretch">
        ...
        <div style="width: 100%; overflow-x: auto; height: 350px;">
            ...
            $animal_result = mysqli_query($conn, $sql);
                 ...
                 if (mysqli_num_rows($animal_result) > 0) {
                      ...
                      echo "<td>" . $counter_for_animals . "</td>";
                        ...
                        echo "<td>
                                <a title='Edit Pet' class='custom-button' href='backend/update_pet.php?animals_id=" . $row['animals_id'] . "'>
                                    <i class='fas icon'>&#xf044;</i>
                                </a>
                               
                                <a title='Delete Pet' class='custom-button1'  data-id='" . $row["animals_id"] . "' href='#'><i class='fas fa-trash icon'></i></a>
          ...
          <button onclick="window.location.href='pet_archive.php'" style="color:#E1D9D1; background-color: #f34e4e; "><i class="fas fa-trash icon" style="color: #E1D9D1;"></i> Trash</button>
