  ...
  <form id="petForm">
    <div class="row">
      <div class="form-group col-md-6" style="width: 100%; max-width: 300px; margin-bottom: 10px;">
          <label for="animal_name" style="font-size: 12px;">&#x1F415 Pet Name:</label>
          <input class="form-control" type="text" id="animal_name" name="animal_name" required>
      </div>
    </div>
    <div class="row">
       <div class="form-group col-md-6" style="width: 100%; max-width: 300px; margin-bottom: 10px;">
          <label for="breed" style="font-size: 12px;">&#x1F415 Pet Breed:</label>
    ...
    <div class="row">
       <div class="form-group" style="width: 100%; max-width: 300px; margin-bottom: 10px;">
          <label for="species" style="font-size: 12px;">&#x1F415 Pet Species:</label>
          <select class="form-control" id="species" onchange="checkIfOthers()" required>
           ...
           <div id="otherSpeciesContainer" style="display:none; width: 100%; max-width: 300px; margin-bottom: 10px;">
              <label for="otherSpecies" style="font-size: 12px;">&#x1F415 Input Species</label>
      ...
      <div class="row">
                <div class="form-group" style="width: 100%; max-width: 180px; margin-bottom: 10px;">
                  <label for="sex" style="font-size: 12px;">&#9893; Pet Gender</label>
                 ...
                 <div class="form-group" style="width: 100%; max-width: 180px; margin-bottom: 10px;">
                   ...
                   <label for="birthdate" style="font-size: 12px;">&#x1F4C5; Pet's Birthday:</label>
                ...
                <div class="form-group" style="width: 100%; max-width: 180px; margin-bottom: 10px;">
                    ...
                    <label for="age" style="font-size: 12px;">&#x1F43E; Pet's Age:</label>
                ...
                <div class="form-group" style="width: 100%; max-width: 180px; margin-bottom: 10px;">
                  <label for="quantity" style="font-size: 12px;">&#x1F43E; Pet Quantity</label>
                  <input type="number" class="form-control" name="quantity" id="quantity" min="1" pattern="[1-9]\d*" required style="font-size: 12px;" required>
                </div>        
