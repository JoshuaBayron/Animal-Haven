  ...
  load_unseen_notification();;
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="add-appointment.php" class="nav-link scrollto"><i class="far fa-calendar-plus"></i> <span>Add Appointment</span></a></li>
          <!-- <li><a href="schedule/index.php" class="nav-link scrollto"><i class="bx bx-alarm-add"></i> <span>Calendar</span></a></li> -->
