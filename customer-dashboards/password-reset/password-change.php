    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('bg.jpg');">
            <div class="wrap-login100">
                ...
                <form method="post" action="http://localhost//Pawpointment-Final/PawPointment/customer-dashboards/backend/password-reset-code.php" class="login100-form validate-form">
