...
function send_password_reset($get_name, $get_email, $token)
{
            ...
            $email_body = "
                        ...
                        <br><br>
                        <a href='http://localhost//Pawpointment-Final/PawPointment/logins/password-change.php?token=$token&email=$get_email'>Click Me!</a>
    		 ...
    		 echo "<script>
                Swal.fire({
                    ...
                    if (result.dismiss === Swal.DismissReason.timer) {
                        window.location.href = '../password-reset.php'; // Redirect to desired page after successful insert
                    }
                });
            </script>";
			...
			// echo "Something went wrong";
			 echo "<script>
                Swal.fire({
                    ...
                    if (result.dismiss === Swal.DismissReason.timer) {
                        window.location.href = '../password-reset.php'; // Redirect to desired page after error
                    }
                });
            </script>";
						...
						$check_token_run = mysqli_query($conn,$update_to_new_token);
						   	echo "<script>
				                Swal.fire({
				                    ...
				                    if (result.dismiss === Swal.DismissReason.timer) {
				                        window.location.href = '../../index.php'; // Redirect to desired page after successful insert
				                    }
				                });
				            </script>";
					    	...
					    	echo "<script>
				                Swal.fire({
				                    ...
				                    if (result.dismiss === Swal.DismissReason.timer) {
				                        window.location.href = '../password-change.php?token=$token&email=$email'; // Redirect to desired page after error
				                    }
				                });
				            </script>";
					    }
