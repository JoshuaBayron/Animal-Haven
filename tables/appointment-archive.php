                    ...
                    while ($row = mysqli_fetch_array($result)) {
                     ...
                     if ($payment !== null) {
                        ...
                        echo '<tr>
                                ...
                                <a class="custom-button" href="backend/crude.php?appointment_no=' . $row["appointment_id"] . '&role=deleteAppointment"  onclick="return confirm(\'Are you sure you want to permanently delete this appointment?\')" style="background-color: #8B0000">Delete</a>
                                </td>
                                </td>
