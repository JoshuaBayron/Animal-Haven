              ...
              <?php
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_array($result)) {  
                        ...
                        echo '<tr>
                                <td>
                                    <a class="custom-button" href="login-form/update-status1.php?appointment_no=' . $row["appointment_id"] . '&referral='.$row["referral_no"]. '&animalName='.$row["animal_name"].'&fullname='.$fullname.'">Edit</a>
