        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo '<tr>
                            <td>
                                <a class="custom-button" href="login-form/update-status.php?appointment_no=' . $row["appointment_id"] . '&animalName=' . $row["animal_name"] . '&customerEmail=' . $row["customer_email"] . '&staffEmail=' . $row["staff_email"] . '" style="background-color:#8B4000">Edit</a>
                                ...
                                if (stripos($row["appointment_status"], "Pending") !== false || stripos($row["appointment_status"], "To be scheduled") !== false) {
                                  echo '<a class="custom-button" href="backend/crude.php?appointment_no=' . $row["appointment_id"] . '&role=approve" style="background-color:green">Approve</a>';
                                  echo '<a class="custom-button" href="backend/crude.php?appointment_no=' . $row["appointment_id"] . '&role=cancel" style="background-color:red">Cancel</a>';
                                } else {
                                    echo '<a class="custom-button" href="pet-status.php" style="background-color:gray">Submitted</a>';
                                }
