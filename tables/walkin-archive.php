                    ...
                    while ($row = mysqli_fetch_array($result)) {  
                        ...
                        echo '<tr>
                                <td>
                                    ...
                                    <a class="custom-button" href="backend/crude.php?referral='.$row["referrals"].'&appointment_no=' . $row["appointment_id"] . '&role=delete-status"  onclick="return confirm(\'Are you sure you want to Permanently delete this appointment?\')">Delete</a>
                                </td>
